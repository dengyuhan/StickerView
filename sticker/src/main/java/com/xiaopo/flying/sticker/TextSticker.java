...
public class TextSticker extends Sticker {
    ...
    public TextSticker setMaxTextSize(@Dimension(unit = Dimension.SP) float size) {
        return setMaxTextSize(convertSpToPx(size));
    }

    @NonNull
    public TextSticker setMaxTextSize(int size) {
     ...
     */
    @NonNull
    public TextSticker setMinTextSize(@Dimension(unit = Dimension.SP) float minTextSizeScaledPixels) {
        return setMinTextSize(convertSpToPx(minTextSizeScaledPixels));
    }
